...
"use strict";$(".greet-wrap").on("mousemove",function(e){var t=e.pageX/$(window).width(),a=e.pageY/$(window).height();$(".greet-parallax").css("transform","translate(-"+30*t+"px, -"+30*a+"px)"),$(".greet").css("transform","translate("+30*t+"px, "+30*a+"px)")});